...
<meta http-equiv="Cache-Control" content="no-siteapp" />
 <link href="${path}/static/background/assets/css/bootstrap.min.css" rel="stylesheet" />
        ...
        <script src="${path}/static/background/assets/js/jquery.easy-pie-chart.min.js"></script>
        <script src="${path}/static/background/js/lrtk.js" type="text/javascript" ></script>
<title>订单管理</title>
</head>
