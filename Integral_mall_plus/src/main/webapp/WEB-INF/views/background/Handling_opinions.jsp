...
<body>
                           ...
                           <c:if test="${o.audittype == 2}">
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <a href="javascript:ovid()" class="Headmaster_modal_Handling_opinions" yjid="${o.integralauditno}"
                                          empname="${o.empId.empname}" changenum="${o.changeint}" title="处理意见请求">处理</a>
                                   </td>
                               </tr>
                           </c:if>
    ...
    <div class="DivHandling_opinions" id="update_menber_style" style="display:none">
        <ul class=" page-content">
         ...
         <%--校长模态框--%>
         <div class="DivXzHandling_opinions" id="update_menber_style" style="display:none">
             <ul class=" page-content">
                 <form action="bgUpdEmp" method="post" name="updTable" >
                     <br/>
                     <li style="display: inline-block"><label class="label_name">意&nbsp;&nbsp;见&nbsp;&nbsp;编&nbsp;&nbsp;号：</label><span class="add_name">
                    <input  name="integralauditno" id="xzintegralauditno" disabled="disabled" type="text"  class="text_add"/></span><div class="prompt r_f"></div></li>
                     <li style="display: inline-block"><label class="label_name">员&nbsp;&nbsp;工&nbsp;&nbsp;姓&nbsp;&nbsp;名：</label><span class="add_name">
                    <input  name="empname" id="xzempname" type="text" disabled="disabled" class="text_add"/></span><div class="prompt r_f"></div></li>
                     <br/><br/><br/>
                     <li><label class="label_name">积分变动数量：</label><span class="add_name">
                    <input  name="changeint" id="xzchangeint" type="text" disabled="disabled" class="text_add"/></span><div class="prompt r_f"></div></li>
                     <br/>
                     <br/>
                     <div class="form-group"  >
                         <label  class="col-sm-2 control-label">您的意见dsadsadsadasd:</label>
                         <div class="col-sm-10" >
                             <textarea class="form-control" id="Boss_opinion" rows="3" style="width: 200px;"></textarea>
                         </div>
                     </div>
                     </span><div class="prompt r_f"></div></li>
                     <br/>
                     <br/>
                     <button type="button" class="btn btn-success BoosApproval" style="margin-left: 150px;">批准</button>
                     <button type="button" class="btn btn-danger BoosRefuse" style="margin-left: 100px;">拒绝</button>
                     <br/>
                     <br/>
                 </form>
             </ul>
...
<script type="text/javascript">
    $(function () {
        ...
        $(".Headmaster_modal_Handling_opinions").click(function () {
            var integralauditno = $(this).attr("yjid");
            var empname = $(this).attr("empname");
            var changeint = $(this).attr("changenum");
            $("#xzintegralauditno").val(integralauditno);
            $("#xzempname").val(empname);
            $("#xzchangeint").val(changeint);
            layer.open({
                type: 1,
                title: '处理',
                offset: '180px',
                ...
                shadeClose: true, //点击遮罩关闭层
                area : ['600px' , ''],
                content:$('.DivXzHandling_opinions'),
            });
        })
        ...
        $(".BoosApproval").click(function () {
            var audiId = $("#xzintegralauditno").val(); //意见编号
            var Boss_opinion = $("#Boss_opinion").val(); //意见内容
            $.ajax({
                url:"xzApproval_opinion",
                type:"post",
                data:{audiId:audiId,Boss_opinion:Boss_opinion},
                success:function (result) {
                    if(result=="y"){
                        layer.msg("同意成功");
                        setTimeout(function () {
