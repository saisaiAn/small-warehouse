                        ...
                        <div class="container-fluid">
                                    ...
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <div class="embed-responsive embed-responsive-16by9">
                                               <!--  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/shIr3vAw98I"></iframe> -->
                                            </div>
                                        </div>
                                    </div>
                                </div> <!-- end col -->
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xl-4">                                    
                                    <div class="card m-b-30">
                                        <img class="card-img-top img-fluid" src="/static/app/assets/images/news/img-1.jpg" alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title font-20 mt-0">News Pepar</h4>
                                    ...
                                    <div class="card m-b-30">
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner">
                                                ...
                                                <img class="d-block w-100"  src="/static/app/assets/images/news/img-4.jpg" alt="First slide">
                                                </div>
                                                <div class="carousel-item">
                                                <img class="d-block w-100"  src="/static/app/assets/images/news/img-3.jpg" alt="Second slide">
                                                </div>
                                                <div class="carousel-item">
                                                <img class="d-block w-100"  src="/static/app/assets/images/news/img-4.jpg" alt="Third slide">
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <h4 class="card-title font-20 mt-0">World Marcket News</h4>
                                            <p class="card-text">This is a longer card with supporting text below as
                                                a natural lead-in to additional content. This content is a little
                                                bit longer.
                                            </p>                                                    
                                ...
                                <div class="col-md-12 col-xl-4"> 
                                    <div class="card m-b-30">
                                        <img class="card-img-top img-fluid" src="/static/app/assets/images/news/img-2.jpg" alt="Card image cap">
                                        <div class="card-body">
                                            <h4 class="card-title font-20 mt-0">Bitcoin News</h4>
                                            <p class="card-text">This is a longer card with supporting text below as
                                                a natural lead-in to additional content. This content is a little
                                                bit longer.
                                            </p>                                                    
