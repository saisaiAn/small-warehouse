...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="/static/app/assets/images/favicon.ico">
         ...
         <!--Morris Chart CSS -->
         <link rel="stylesheet" href="/static/app/assets/plugins/morris/morris.css">
    ...
    <body class="fixed-left">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-8">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title">Buy & Sell</h4>                                            
                                ...
                                <div class="col-md-12 col-xl-4">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title">My Balance</h4>                                            
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-6">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title">Buy Orders</h4>
                                            <div class="table-responsive-sm mt-2">
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col" class="border-top-0"><b>Amount (BTC)</b></th>
                                                            <th scope="col" class="border-top-0"><b>Price</b></th>
                                                            <th scope="col" class="border-top-0"><b>Total ($)</b></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                ...
                                <div class="col-md-12 col-xl-6">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title">Sell Orders</h4>
                                            <div class="table-responsive-sm mt-2">
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
        ...
        <script src="/static/app/assets/pages/crypto-exchange.init.js"></script>
